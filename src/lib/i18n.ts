...
const en: Translations = {
  ...
  sellOn: 'Sell on Gulit.shop', dashboard: 'Dashboard',
...
const am: Translations = {
  ...
  products: 'ምርቶች', orders: 'ትዕዛዞች', customers: 'ደንበኞች',
...
const or: Translations = {
  ...
  sellOn: 'Gulit.shop irratti gaddi', dashboard: 'Daashboordii',
  ...
  products: 'Maamiloo', orders: 'Ajaja', customers: 'Maamiltoota',
...
const ti: Translations = {
  ...
  products: 'ምርታት', orders: 'ትእዛዛት', customers: 'ደንበኛታት',
...
const so: Translations = {
  ...
  sellOn: 'Ku Iibso Gulit.shop', dashboard: 'Bogga Farsamada',
  ...
  products: 'Alaab', orders: 'Amaro', customers: 'Macaamiil',
