...
export async function POST(req: Request) {
  try {
    ...
    const {
      name, description, price, originalPrice, stock, sku,
      categoryIcon, categoryId, deliveryDays, isLocal, isOrganic,
      isHandmade, isFeatured, isBestseller, tags,
    } = body
