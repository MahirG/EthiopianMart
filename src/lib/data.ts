...
export const paymentMethods: PaymentMethod[] = [
  ...
  { id: 'wallet', name: 'Gulit.shop Wallet', type: 'wallet', icon: '👛', color: 'from-teal-500 to-cyan-600', description: 'Your digital wallet', balance: 2840 },
...
export const customerReviews = [
  {
    ...
    rating: 5,
    text: 'Gulit.shop completely changed how I shop. The AI assistant helped me find the cheapest Samsung phone and I saved 3,600 Birr! Delivery was next-day to Bole. This is the future of Ethiopian shopping.',
  ...
  },
  {
    ...
    location: 'Adama',
    rating: 5,
    text: 'As a vendor, Gulit.shop transformed my business. The AI tools helped me optimize pricing and I\'ve increased sales by 40% in 3 months. The dashboard analytics are world-class. Highly recommended for all Ethiopian sellers.',
  ...
  },
  {
    ...
    location: 'Mekelle',
    rating: 5,
    text: 'The Habesha Kemis I ordered for my wedding was handmade and absolutely stunning. The artisan who made it was verified, and the quality exceeded my expectations. Gulit.shop supports local Ethiopian craftsmanship.',
  ...
  },
  {
    ...
    location: 'Hawassa',
    rating: 5,
    text: 'Telebirr payment was instant and seamless. The cashback rewards have saved me over 1,300 Birr this year. The app works perfectly even on slower networks — Gulit.shop truly understands Ethiopian infrastructure.',
    product: 'Gulit.shop Wallet',
  ...
  },
  {
    ...
    location: 'Jimma',
    rating: 5,
    text: 'The AI price prediction told me to wait 3 days for a better deal on cooking oil — and it was right! I saved 400 Birr. No other shopping app in Ethiopia offers this level of intelligence. Gulit.shop is a game-changer.',
